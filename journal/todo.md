...
- [~] Блок 5. Бинарный поиск: Pattern_BinarySearch.md [x],
      BinarySearch [~] код написан (23/23 PASS, +виз., +трассировка шагов
      в main), Lela разбирает,
      SearchInsertPosition [~] код написан (19/19 PASS, +виз.), Lela разбирает;
      SearchInsertPositionPractice — её собственное решение той же задачи
      (19/19 PASS), оставлено как след хода размышлений.
      КОД ПО ВСЕМУ БЛОКУ 5 НАПИСАН, остаётся разбор.
