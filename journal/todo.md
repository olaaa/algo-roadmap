...
## Следующий шаг
- [ ] Собрать Блок 2 «Строки + стек» — по тому же шаблону, скомпилировать и прогнать.

- [ ] Визуализации .viz.html для остальных задач блока 1: ValidPalindrome, MergeSortedArray
      (шаблон и рецепт — в progress.md, запись 2026-07-06).
