...
- [~] Блок 6. Деревья и базовые графы: TreeNode (общий узел блока),
      ...
      [ ] LELA САМА пишет isSymmetric без рекурсии, на явной структуре
          ...
          код не писать, подсказок не давать, пока Lela не покажет свой
          вариант; каркас с тестами сделать по просьбе. После этого дописать
          в SymmetricTree.md раздел «Дополнение: без рекурсии».
