...
- [~] Блок 5. Бинарный поиск: BinarySearch [~] код написан (23/23 PASS, +виз.),
      Lela разбирает. Осталось: SearchInsertPosition (35) и обзорный файл блока
...
- [~] ПО ОДНОЙ ЗАДАЧЕ за подход. Для каждой: класс + docs/problems/.md +
      ...
      к сложному.
      Блок 5 «Бинарный поиск» начат: BinarySearch (704) написан и прогнан.
      Следующая задача — SearchInsertPosition (35); обзорный файл блока
      Pattern_BinarySearch.md пишем после неё, когда будут обе задачи.
