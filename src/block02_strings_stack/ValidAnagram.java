...
//            letterCounts[t.charAt(currentIndex) - 'a'] = letterCounts[t.charAt(currentIndex) - 'a'] - 1;
    ...
    public static void main(String[] args) {
         ...
         *   3) второй цикл: count != 0 -> return false ...... "rat" / "car", "aacc" / "ccac"
         *   4) второй цикл прошёл, всё ноль -> return true ... "anagram" / "nagaram"
         * Пустых строк среди случаев нет: ограничения задают 1 <= s.length.
