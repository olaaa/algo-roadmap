 ...
 * <p>
 * В стек кладётся не узел, а пара «узел, его глубина»: глубина узла известна
 * в момент, когда его кладут, — на единицу больше глубины родителя, — и после
 * снятия узла возвращаться к нему не надо. Ответ — наибольшая из снятых глубин.
 * Время O(n), память O(h), где h — высота дерева: в стеке одновременно лежит
 * не больше h + 1 пар — по одному отложенному правому потомку на каждый
 * уровень текущего пути от корня.
 *
