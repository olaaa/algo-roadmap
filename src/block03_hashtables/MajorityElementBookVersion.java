 ...
 * «Карьера программиста», глава «Сложные задачи» (Часть IX, с. 190 /
 * Часть X «Решения», с. 560).
 * <p>
...
public class MajorityElementBookVersion {
    ...
    public static void main(String[] args) {
        ...
        /*
         * ОСТОРОЖНО С ЭТИМ МАССИВОМ. В RAG-файле он напечатан дважды и версии
         * разошлись из-за OCR: в строку — «3 1 7 1 3 7 3 7 1 7 7» (семёрок 5
         * из 11, доминирующего значения нет), столбцом — «3 1 7 1 1 7 7 3 7 7 7»
         * (семёрок 6 из 11, доминирующее есть).
         * Правильная версия вторая: только на ней сходится трассировка из самой
         * книги — validate(3) видит 3,1 и останавливается; validate(7) видит 7,1;
         * validate(1) видит 1,7; validate(7) видит 7,3; последний validate(7)
         * видит 7,7,7.
